...
class LevelTaskController extends Controller implements HasMiddleware
{
    ...
    {
        $level = LevelTask::with('level','fromSurah','toSurah','fromAyah','toAyah','reviewFromSurah','reviewToSurah','reviewFromAyah','reviewToAyah')->searchAndFilter()->orderBy('id', 'asc')->paginate(10);
