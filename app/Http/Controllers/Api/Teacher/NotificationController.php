...
class NotificationController extends Controller
{
    ...
    {
        $user = auth()->guard("teacher_api")->user();
    ...
    {
        auth()->guard("teacher_api")->user()->notifications()->where('id', $id)->update(['read_at' => now()]);
    ...
    {
        auth()->guard("teacher_api")->user()->notifications()->where('id', $id)->delete();
