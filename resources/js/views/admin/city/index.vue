<template>
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">{{ $t('global.cities') }}</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><router-link :to="{name: 'dashboard'}">{{$t('global.home')}}</router-link></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ $t('global.cities') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="prism-toggle">
                            <button v-if="permission.includes('city create')" @click="showModelCreate" class="btn btn-sm btn-primary-light" data-bs-toggle="modal" data-bs-target="#category-service">
                                ...
                                <tr v-for="(item,index) in data" :key="item.id">
                                    ...
                                    <td>
                                        <div class="hstack gap-2 fs-15">
                                            <button v-if="permission.includes('city edit')"
                                             ...
                                             <a href="#" @click.prevent="deleteData(item.id,index)" v-if="permission.includes('city delete')"
