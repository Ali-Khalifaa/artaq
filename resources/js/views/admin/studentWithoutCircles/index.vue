<template>
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">{{ $t('global.studentWithoutCircles') }}</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><router-link :to="{ name: 'dashboard' }">{{ $t('global.home')
                                }}</router-link></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ $t('global.studentWithoutCircles') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <tr v-for="(item, index) in data" :key="item.id">
                                        ...
                                        <td>
                                            <div class="hstack gap-2 fs-15">
                                                ...
                                                <button v-if="permission.includes('add circle to student')"
                                                    ...
                                                    :title="$t('role_and_permissions.add circle to student')">
...
export default {
    ...
    setup() {
        ...
        onBeforeMount(() => {
            uri.value = 'student-without-circles';
            getData();
        });
