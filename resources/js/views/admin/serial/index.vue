<template>
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">{{ $t('global.serials') }}</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><router-link :to="{name: 'dashboard'}">{{$t('global.home')}}</router-link></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ $t('global.serials') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="table-responsive mb-2">
                            <table class="table text-nowrap table-striped">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">{{ $t('label.prefix') }}</th>
                                    <th scope="col">{{ $t('label.startNumber') }}</th>
                                ...
                                <tr v-for="(item,index) in data" :key="item.id">
                                    ...
                                    <td>
                                        <div class="hstack gap-2 fs-15">
                                            <button v-if="permission.includes('serial edit')"
...
export default {
    ...
    setup(){
        ...
        search.value = {
            ...
            columns: ['id','type','prefix','start_number'],
            searchInRelations: [
                // {
