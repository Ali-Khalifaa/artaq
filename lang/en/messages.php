...
return [
    ...
    */
    ...
    'This teacher is not available right now' => 'This teacher is not available right now',
    'You already have an active session wait till your teacher end it and rate you' => 'You already have an active session wait till your teacher end it and rate you',
    'You already have an active session end it and rate the student' => 'You already have an active session end it and rate the student',
    'Message Sent Successfully' => 'Message Sent Successfully',
    'You already in an intensive track' => 'You already in an intensive track',
    'You already have an intensive request' => 'You already have an intensive request',
    'Pending' => 'Pending',
    'Pending' => 'Pending',
    'Pending' => 'Pending',
    'Pending' => 'Pending',
